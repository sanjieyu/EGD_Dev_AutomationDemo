...
class MYOB_Quotes_Test(unittest.TestCase,MYOB_Quotes):
    ...
    def test_myob_quotes_ui_001(self):
        ...
        self.assertEqual("http://test_sample",self.check_myob_url)

    def test_myob_quotes_ui_002(self):
        '''Verify the title'''
        self.driver.implicitly_wait(2)
        self.assertEqual("test_sample",self.check_myob_title)

    def test_myob_quotes_ui_003(self):
        '''Verify client details section'''
        self.driver.implicitly_wait(2)
        self.assertEqual(("test_sample","test_sample","test_sample"),self.check_client_details)

    def test_myob_quotes_ui_004(self):
        '''Verify Location section'''
        self.driver.implicitly_wait(2)
        self.assertEqual(("test_sample"),self.check_location)
    ...
    def test_myob_quotes_ui_012(self):
        ...
        self.driver.implicitly_wait(2)
        self.assertEqual("test_sample", self.search_myob_fun)
