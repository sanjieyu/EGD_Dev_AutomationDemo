...
from pages.quotation_panel_door import *
...
class Quotation_Panel_Test(unittest.TestCase,Quotation_Panel):
    ...
    def test_quotation_ui_001(self):
        ...
        self.assertEqual(('test_sample'),self.check_major_sections())

    def test_quotation_ui_002(self):
        '''Verify each element in quotation section"'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('test_sample'),self.check_quotation_section())

    def test_quotation_ui_003(self):
        '''Verify the values for each contact detail"'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('test_sample','test_sample',self.proposal_num,'test_sample',
                          'test_sample'),self.check_contact_details())

    def test_quotation_ui_004(self):
        '''Verify each element in job summary section"'''
        self.driver.implicitly_wait(2)
        self.assertEqual('test_sample',self.check_job_summary_section())
    ...
    def test_quotation_ui_014(self):
            ...
            self.driver.implicitly_wait(2)
            self.assertEqual(('test_sample'),self.check_proposal_documents_section())

    def test_quotation_ui_015(self):
        '''Verify the Print Sheet in Proposal Documents section"'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('test_sample'), self.check_print_sheet())

    def test_quotation_ui_016(self):
            '''Verify each element in Door section"'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('test_sample'),self.check_door_section())
