...
class AddQuote_UI_Test(unittest.TestCase,Add_Quote):
    ...
    def test_addquote_ui_001(self):
        ...
        self.assertEqual('http://test_sample',self.check_addquote_url)

    def test_addquote_ui_002(self):
        '''Verify the default section in Add Quotes page'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('test_sample','test_sample','test_sample','test_sample'),self.check_defaulsection)
    ...
    def test_addquote_ui_004(self):
        ...
        self.assertEqual(('test_sample','test_sample','test_sample','test_sample','test_sample',
                          'test_sample','test_sample','test_sample'),self.check_proposal_details)

    def test_addquote_ui_005(self):
        '''Verify each value in "Pricing Category" list'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('test_sample'),self.check_pricing_cate_value)

    def test_addquote_ui_006(self):
        '''Verify the default value in "Pricing Category" list'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('test_sample'),self.check_default_pricing)
    ...
    def test_addquote_ui_012(self):
        ...
        self.driver.implicitly_wait(2)
        self.assertIn(('test_sample'),self.check_supplytype_value)

    def test_addquote_ui_013(self):
        '''Verify the default value in "Supply Type" list, it should be "Please Select"'''
        self.driver.implicitly_wait(2)
        self.assertEqual('test_sample,self.check_supplytype_default)
    ...
    def test_addquote_ui_015(self):
        ...
        self.driver.implicitly_wait(2)
        self.assertEqual(('test_sample','test_sample'),self.check_contact_details)

    def test_addquote_ui_016(self):
        '''Verify each element in "Client Contact Details"'''
        self.driver.implicitly_wait(2)
        self.assertEqual( ('test_sample'),self.check_client_contact_details)
    ...
    def test_addquote_ui_025(self):
        ...
        self.driver.implicitly_wait(2)
        self.assertEqual( ('test_sample'),self.check_site_contact_details)
    ...
    def test_addquote_ui_034(self):
            ...
            self.driver.refresh()
            self.driver.implicitly_wait(2)
            self.assertEqual((['test_sample']),self.check_adddoor_menu)

    def test_addquote_ui_035(self):
            '''Verify the validation in Add Quote page'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('test_sample'),self.check_validation)

    def test_addquote_ui_036(self):
        '''Verify Add a Quote Successfully'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('(test_sample)'),self.check_add_quote_success)
