...
class Rolling_Cycle_Management(Admin_Page):
    ...
    def go_rolling(self):
        ...
        self.driver.find_element(*self.rollcycle_panellift_loc).click()
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located(self.rolling_title_loc))  # new added
        # sleep(2)
    ...
    def check_rolling_title(self):
        '''Check the Title'''
        rolling_title = self.driver.find_element(*self.rolling_title_loc).text
        print(rolling_title)
    ...
    def check_tab(self):
        '''Check each tab'''
        general_settings_title = self.driver.find_element(*self.general_settings_loc).text
        colour_cycles_settings_title = self.driver.find_element(*self.colour_cycle_settings_loc).text
        temp_closed_title = self.driver.find_element(*self.temp_closed_loc).text
        history_title = self.driver.find_element(*self.history_loc).text
    ...
    def check_general_settings(self):
        ...
        split_doors = self.driver.find_element(*self.split_doors_loc).text
        lockout_settings = self.driver.find_element(*self.lockout_settings_loc).text
        default_shift_settings = self.driver.find_element(*self.default_shift_settings_loc).text
    ...
    def check_colour_cycle_settings(self):
        ...
        self.driver.find_element(*self.colour_cycle_settings_loc).click()
        coil_settings = self.driver.find_element(*self.coil_settings_loc).text
        save_btn = self.driver.find_element(*self.save_coil_btn_loc).text
    ...
    def check_temp_closed(self):
        ...
        self.driver.find_element(*self.temp_closed_loc).click()
        temp_closed_cycles = self.driver.find_element(*self.temp_closed_cycles_loc).text
        update_cycles_btn  = self.driver.find_element(*self.update_cycles_btn_loc).text
...
if __name__ == '__main__':
    ...
    login = Rolling_Cycle_Management(driver)
