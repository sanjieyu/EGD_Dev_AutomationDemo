...
from UIModule.dealer_insulated_door import *
...
class Add_DP_Insulated(Dealer_Insulated_Door):
    ...
    def validation_input(self):
        ...
        sleep(3)
        self.driver.find_element(*self.add_insulateddoor_btn_loc).click()
        sleep(2)
    ...
    def add_dealer_insulated_door(self):
        sleep(5)
        ...
        self.driver.find_element(*self.seals_quantity_2500_loc).send_keys('3')
...
if __name__ == '__main__':
        ...
        # login.add_dealer_insulated_door()
