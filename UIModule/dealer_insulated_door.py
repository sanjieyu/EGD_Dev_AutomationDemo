# Author:Yi Sun(Tim) 2024-11-08

'''Add a Dealer Insulated Door Details Page'''
...
class Dealer_Insulated_Door(Add_Dealer_Quote):

    details_title_loc  = (By.XPATH,'/html/body/div[3]/div[2]/div[2]/div/div/div/form/h1')
    add_insulateddoor_btn_loc = (By.ID,'btnDoorAdd')
    ...
    colour_category_loc = (By.XPATH,'/html/body/div[3]/div[2]/div[2]/div/div/div/form/div[1]/div[3]/div[3]/fieldset/label')
    ...
    lsr_kit_loc = (By.XPATH,'/html/body/div[3]/div[2]/div[2]/div/div/div/form/div[1]/div[4]/fieldset/div[3]/div[2]/'
                            'label')
    ...
    wall_button_loc = (By.XPATH,'/html/body/div[3]/div[2]/div[2]/div/div/div/form/div[1]/div[3]/div[19]')
    ...
    windows_colour_btn_loc = (By.XPATH,'/html/body/div[3]/div[2]/div[2]/div/div/div/form/div[1]/div[8]/div/div/div[2]/'
                                       'div/div/div/fieldset/div/div[3]/span/a')
    windows_colour_dropdown_loc = (By.XPATH,'//*[@id="ui-id-1"]')

    def go_insulated_door(self):
        '''Open the Add Insulated Door from Dealer Quote Page'''
        self.driver.find_element(*self.insulated_btn_loc).click()
        sleep(3)
    ...
    def check_door_page(self):
        ...
        insulated_detail_title = self.driver.find_element(*self.details_title_loc).text
        self.driver.execute_script("arguments[0].scrollIntoView(false);", form_element)
        add_button = self.driver.find_element(*self.add_insulateddoor_btn_loc).text
        print(insulated_detail_title,add_button)
        return insulated_detail_title,add_button
...
if __name__ == '__main__':
        ...
        login = Dealer_Insulated_Door(driver)
        login.typeUserName('aa@ecogaragedoors.com')
        login.typePassword('aabb')
        login.clickLogin()
        login.creat_quote()
        login.go_insulated_door()
