...
class Add_Roller_Door(Standard_Door):
    ...
    """
    new_door_page_loc = (By.ID, 'test_sample')
    new_door_title = (By.NAME, 'test_sample')
    new_door_duplicate = (By.CSS_SELECTOR, "test_sample")
    new_door_delete = (By.ID, 'test_sample')
    default_track_box_loc = (By.ID,'test_sample')
    ...
    def add_roller_door(self):
        ...
        install_type_select.select_by_visible_text('test_sample')
        ...
        design_select.select_by_visible_text('test_sample')
        colour_category_select = Select(self.driver.find_element(*self.colour_category_select))
        colour_category_select.select_by_visible_text('test_sample')
        door_colour_select = Select(wait.until(EC.presence_of_element_located(self.door_colour_select)))
        door_colour_select.select_by_visible_text('test_sample')
        door_finish_select = Select(self.driver.find_element(*self.door_finish_select))
        door_finish_select.select_by_visible_text('test_sample')
        self.driver.find_element(*self.opensize_lh_select).clear()
        self.driver.find_element(*self.opensize_lh_select).send_keys('test_sample')
        self.driver.find_element(*self.opensize_rh_select).clear()
        self.driver.find_element(*self.opensize_rh_select).send_keys('test_sample')
        self.driver.find_element(*self.opensize_width_select).clear()
        self.driver.find_element(*self.opensize_width_select).send_keys('test_sample')
        self.driver.find_element(*self.sr_left_select).clear()
        self.driver.find_element(*self.sr_left_select).send_keys('test_sample')
        self.driver.find_element(*self.hr_select).clear()
        self.driver.find_element(*self.hr_select).send_keys('test_sample')
        self.driver.find_element(*self.sr_right_select).clear()
        self.driver.find_element(*self.sr_right_select).send_keys('test_sample')
        opener_select = Select(self.driver.find_element(*self.opener_select))
        opener_select.select_by_visible_text('test_sample')
    ...
    def track_t50(self):
        ...
        self.driver.find_element(*self.opensize_width_select).clear()
        self.driver.find_element(*self.opensize_width_select).send_keys('test_sample')
        self.driver.find_element(*self.hr_select).send_keys(Keys.RETURN)
        default_track_box = self.driver.find_element(*self.default_track_box_loc)
        default_track_value = default_track_box.get_attribute('value')
        print(default_track_value)
        return default_track_value
