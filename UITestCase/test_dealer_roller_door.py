...
from time import *
from UIModule.dealer_roller_door import *
from CommonModule.read_config import *

class Add_RollerDoor_UI_Test(unittest.TestCase,Dealer_Roller_Door):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.rollerdoor = Dealer_Roller_Door(cls.driver)
        cls.rollerdoor.creat_quote()
        cls.rollerdoor.go_roller_door()
        sleep(3)
    ...
    def test_roller_door_ui_001(self):
    ...
    def test_roller_door_ui_002(self):
    ...
    def test_roller_door_ui_003(self):
        '''Verify if the Door type dropdown is disabled '''
        self.driver.implicitly_wait(2)
        self.assertFalse( self.check_door_type)

    def test_roller_door_ui_004(self):
            '''Verify the default value of the Door type dropdown'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('ExoRoll'), self.check_default_door_type)

    def test_roller_door_ui_005(self):
            '''Verify the values in the Design dropdown'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('Please Select\nExoRoll eS\nExoRoll eD\nExoRoll eC'), self.check_design)

    def test_roller_door_ui_006(self):
            '''Verify the values in the Colour Category dropdown'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('Please Select\nColorBond'), self.check_colour_category)

    def test_roller_door_ui_007(self):
    ...
    def test_roller_door_ui_016(self):
        '''Verify the default value for Seals 3000mm Quantity'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('0'), self.check_quantity_3000)


    def test_roller_door_ui_017(self):
            '''Verify the default value for Dealer Seals Quantity'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('0'), self.check_quantity_default)

    def test_roller_door_ui_018(self):
    ...
    def test_roller_door_ui_026(self):
        '''Verify the Dealer Seals dropdown list'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('Additional Door Information'), self.check_additional_details)

    def test_roller_door_ui_027(self):
        '''Verify each element for Extras'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('Window Type','No. of Windows','Window Colour'), self.check_extras_details)

    def test_roller_door_ui_028(self):
        '''Verify the windows type dropdown list, should disable'''
        self.driver.implicitly_wait(2)
        self.assertTrue(self.check_windows_type)

    def test_roller_door_ui_029(self):
        '''Verify the windows colour dropdown list,should disable'''
        self.driver.implicitly_wait(2)
        self.assertTrue(self.check_windows_colour)

    def test_roller_door_ui_030(self):
        '''Verify the windows colour dropdown list,should disable'''
        self.driver.implicitly_wait(2)
        self.assertTrue(self.check_windows_no)

    def test_roller_door_ui_031(self):
        '''Verify the Tape dropdown list'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('Please Select\nEco Precision Drive RDO\nLock Only RDO\nManual/No Opener or Lock'),
                         self.check_opener_list)
