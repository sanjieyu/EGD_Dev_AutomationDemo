...
'''Test Dealer Panel Lift Door Details Page'''
...
class Add_PanelDoor_UI_Test(unittest.TestCase,Dealer_Panel_Door):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.paneldoor = Dealer_Panel_Door(cls.driver)
        cls.paneldoor.creat_quote()
        cls.paneldoor.go_panel_door()
        sleep(3)
    ...
    def test_panel_door_ui_001(self):
    ...
    def test_panel_door_ui_002(self):
    ...
    def test_panel_door_ui_003(self):
        '''Verify if the Door type dropdown is disabled '''
        self.driver.implicitly_wait(2)
        self.assertFalse( self.check_door_type)

    def test_panel_door_ui_004(self):
            '''Verify the default value of the Door type dropdown'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('Panel Lift-Safe'), self.check_default_door_type)

    def test_panel_door_ui_005(self):
            '''Verify the values in the Design dropdown'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('Please Select\nSlimline\nClassic panel\nLincoln panel\nUltraline\nWideline'),
                             self.check_design)

    def test_panel_door_ui_006(self):
            '''Verify the values in the Colour Category dropdown'''
            self.driver.implicitly_wait(2)
            self.assertEqual(('Please Select\nColorBond\nCustom\nFlexographic\nMetalFx\nPainted Finish\nPortabella\n'
                              'PowderCoatStandard\nPowderCoatUpgrade\nTimber Essence'), self.check_colour_category)

    def test_panel_door_ui_007(self):
    ...
    def test_panel_door_ui_023(self):
    ...
    def test_panel_door_ui_024(self):
    ...
    def test_panel_door_ui_034(self):
        ...
        self.assertEqual(('Please Select\n2 Lite Hampton Classic\n4 Lite Hampton Classic\n4 Lite Hampton Lincoln\n'
                         ...
                         self.check_windows_type)

    def test_panel_door_ui_035(self):
