...
'''Test Add a OptiRoll Door Functian'''

import time
import unittest
from selenium import webdriver
from time import *
from UIModule.add_optiroll_door import *
from CommonModule.read_config import *

class Add_OptiRoll_Fun_Test(unittest.TestCase,Add_OptiRoll_Door):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.add_optiroll = Add_OptiRoll_Door(cls.driver)
    ...
    def test_add_optiroll_door_fun_001(self):
        '''Verify the add OptiRoll door function'''
        self.driver.implicitly_wait(2)
        self.add_optiroll.add_optiroll_door()
        self.add_optiroll.new_added_door
        self.assertEqual(('1   OptiRoll, OptiRoll eS, Smooth Texture, Monument (2100 x 3020)'), self.new_added_door)

    def test_add_optiroll_door_fun_002(self):
    ...
    def test_add_optiroll_door_fun_003(self):
