...
'''Test Roller Doors Page'''

import time
import unittest
from selenium import webdriver
from time import *
from UIModule.roller_doors import *
from CommonModule.read_config import *
from selenium.webdriver.support.ui import WebDriverWait

class Roller_Doors_UI_Test(unittest.TestCase,Roller_Doors):
    @classmethod
    ...
    def test_rollerdoors_ui_001(self):
        '''Verify each section in Roller Doors page'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('Order','Rollforming','Assembly','Modifications',
                          'Extras Orders','QC'),self.check_roller_doors_section)

    def test_rollerdoors_ui_002(self):
    ...
    def test_rollerdoors_ui_010(self):
        '''Verify the Save btn in Assembly table'''
        self.driver.implicitly_wait(2)
        self.assertTrue(self.check_modification_save)

    def test_rollerdoors_ui_011(self):
