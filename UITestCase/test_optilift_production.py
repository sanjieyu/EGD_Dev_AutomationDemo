...
'''Test OptiLift Doors Production Page'''

import time
import unittest
from selenium import webdriver
from time import *
from UIModule.optilift_production import *
from CommonModule.read_config import *
from selenium.webdriver.support.ui import WebDriverWait

class OptiLift_Production_UI_Test(unittest.TestCase,OptiLift_Production):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.goproduction_wa = OptiLift_Production(cls.driver)
        cls.goproduction_wa.go_production_wa()
        cls.goproduction_wa.go_optilift()
    ...
    def test_optilift_production_ui_001(self):
        '''Verify each section in OptiLift Production page'''
        self.driver.implicitly_wait(2)
        self.assertEqual(('Order','Assembly','Modifications','Extras Orders','QC'),
                         self.check_optilift_doors_section)

    def test_optilift_production_ui_002(self):
    ...
    def test_optilift_production_ui_014(self):
        '''Verify the Save btn in Assembly table'''
        self.driver.implicitly_wait(2)
        self.assertTrue(self.check_modification_save)

    def test_optilift_production_ui_015(self):
