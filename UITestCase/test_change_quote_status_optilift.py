...
'''Test Change Quote Status for OptiLift doors '''

import unittest
from selenium import webdriver
from CommonModule.read_config import *
from UIModule.change_quote_status_optilift import *

class Change_Quote_Status_OptiLift_Test(unittest.TestCase,Change_Quote_Status_OptiLift):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.go_status = Change_Quote_Status_OptiLift(cls.driver)
    ...
    def test_status_change_optilift_ui_001(self):
    ...
    def test_status_change_optilift_ui_002(self):
    ...
    def test_status_change_optilift_ui_003(self):
