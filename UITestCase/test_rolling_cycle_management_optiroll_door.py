...
'''Test Rolling Cycle Management Page for OptiRoll Doors'''

import unittest
from selenium import webdriver
from CommonModule.read_config import *
from UIModule.rolling_cycle_management_optiroll_door import *

class Rolling_OptiRollDoor_UI_Test(unittest.TestCase,Rolling_Cycle_Management_Optiroll_Door):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.go_rolling_management_optiroll = Rolling_Cycle_Management_Optiroll_Door(cls.driver)
        cls.go_rolling_management_optiroll.go_optiroll()

    @classmethod
    def tearDownClass(cls) -> None:
        cls.driver.quit()

    def test_rolling_management_optiroll_ui_001(self):
        '''Verify the url of Rolling Cycle Management Roller Door Page'''
        self.driver.implicitly_wait(2)
        self.assertEqual( 'http://aabb/Manage/Rollforming/OptiRoll',self.check_rolling_url)

    def test_rolling_management_optiroll_ui_002(self):
        '''Verify the title of Rolling Cycle Management Page'''
        self.driver.implicitly_wait(2)
        self.assertEqual( 'Rolling Cycle Management - OptiRoll Doors  ',self.check_rolling_title)

    def test_rolling_management_optiroll_ui_003(self):
    ...
    def test_rolling_management_optiroll_ui_004(self):
    ...
    def test_rolling_management_optiroll_ui_005(self):
    ...
    def test_rolling_management_optiroll_ui_006(self):
