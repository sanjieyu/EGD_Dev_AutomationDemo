...
from UIModule.change_quote_status import *

class Change_Quote_Status_Test(unittest.TestCase,Change_Quote_Status):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.go_status = Change_Quote_Status(cls.driver)
    ...
    def test_status_change_ui_001(self):
    ...
    def test_status_change_ui_002(self):
    ...
    def test_status_change_ui_003(self):
