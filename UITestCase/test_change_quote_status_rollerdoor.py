...
from UIModule.change_quote_status_rollerdoor import *

class Change_Quote_Status_RollerDoor_Test(unittest.TestCase,Change_Quote_Status_RollerDoor):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls.go_status = Change_Quote_Status_RollerDoor(cls.driver)
    ...
    def test_status_change_rollerdoor_ui_003(self):
